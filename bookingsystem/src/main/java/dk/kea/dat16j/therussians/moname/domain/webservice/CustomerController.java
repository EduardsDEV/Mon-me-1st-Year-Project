...
@RequestMapping(path = "/customers",method = RequestMethod.GET) // This means URL's start with /customers (after Application path)
public class CustomerController {
    ...
    public String addNewCustomer(@RequestParam String firstName,
                                 ...
                                 @RequestParam LocalDate birthday) { // TODO: 10-May-17 Change to LocalDate!!!
